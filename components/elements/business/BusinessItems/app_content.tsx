								...
								<div className='space-y-4 w-full sm:w-auto'>
									<div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
										{metrics.map((metric, index) => (
											<div
												key={index}
												className='flex flex-col items-start gap-2 p-2 rounded-lg'
											>
												{/* Metric label on top */}
							...
							<Table className='rounded-lg overflow-hidden'>
								<TableHeader>
									<TableRow className='bg-[#121315]'>
										<TableHead>Аналітика продажів</TableHead>
					...
					<Card className='bg-[#121315]  text-[var(--foreground)] border-none shadow-none rounded-lg'>
						<CardContent className='p-0 h-full rounded-lg'>
							<div className='flex justify-between items-center px-4 py-2'>
								<h2 className='text-lg font-bold'>Аналітика продажів</h2>
							...
							<Table className='w-full rounded-lg overflow-hidden'>
								...
								<TableBody>
									{popularItems.map(item => (
										<TableRow
											key={item.id}
											className='bg-[#121315] hover:bg-[#1c1d1f]'
										>
											<TableCell className='font-medium'>
												<div className='flex items-center gap-3'>
													<img
